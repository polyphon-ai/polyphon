...
![Voice configuration panel in the Composition Builder showing the Tools section with read-only and write-capable tool toggles](/images/screenshots/compositions/builder-voice-tools.webp)
