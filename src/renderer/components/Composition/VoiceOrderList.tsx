...
import { GripVertical, X, Trash2, ChevronDown, ChevronUp, Check, Lock, TriangleAlert, FileText, FileEdit, FolderOpen, Terminal, Search } from 'lucide-react';
import {
  DndContext,
  closestCenter,
  KeyboardSensor,
...
import { PROVIDER_METADATA, AVAILABLE_TOOLS, type VoiceType } from '../../../shared/constants';
    ...
    <div ref={setNodeRef} style={style} className="mb-2">
      ...
      {isExpanded && (
        <div className="border border-t-0 border-gray-200 dark:border-gray-700 rounded-b-lg bg-gray-50 dark:bg-gray-800/50 p-4 space-y-3">
          ...
          {voiceType === 'api' && enabledTools.some((n) => AVAILABLE_TOOLS.find((t) => t.name === n)?.isWritable) && (
